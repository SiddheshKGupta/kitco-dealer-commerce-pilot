...
- Still required for a working cloud pilot: configure Worker secrets `SUPABASE_URL`, `SUPABASE_SECRET_KEY`, `SESSION_SECRET`, `RESEND_API_KEY`, `OTP_FROM_EMAIL`, `VLCO_TEST_EMAIL`; upload 90 Nike images to R2; deploy; run cloud smoke test.
