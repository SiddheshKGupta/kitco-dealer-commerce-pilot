...
export function App() {
	...
	const dealerPage = pathname.startsWith("/products") ? <DealerCommercePage requestOrderOtp={requestOrderOtp} /> : pathname.startsWith("/orders") ? <OrdersSurface /> : pathname.startsWith("/reports") ? <OrdersSurface reports /> : <WorkspaceHome />;
